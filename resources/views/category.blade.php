...
@section('content')
    <div class="">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="banner-inner-contents">
                            ...
                            <h2 class="banner-inner-title"> All Category </h2>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="category-area padding-top-75 padding-bottom-100">
            <div class="container">
                <div class="row">
                    <div class="col-xl-3 col-md-4 col-sm-6 margin-top-30 category-child">
                    ...
                    <div class="col-xl-3 col-md-4 col-sm-6 margin-top-30 category-child">
                        <div class="single-category style-02 wow fadeInDown" data-wow-delay=".2s">
                            <div class="icon">
                                <img src="assets/img/category/c2.png" alt="">
                            </div>
                            <div class="category-contents">
                                <h4 class="category-title"> <a href="javascript:void(0)"> Home Move </a> </h4>
                                <span class="category-para"> 19+ Service </span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-md-4 col-sm-6 margin-top-30 category-child">
                        <div class="single-category style-02 wow fadeInUp" data-wow-delay=".2s">
                            ...
                            <div class="category-contents">
                                <h4 class="category-title"> <a href="javascript:void(0)"> Electrician </a> </h4>
                                <span class="category-para"> 16+ Service </span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-md-4 col-sm-6 margin-top-30 category-child">
                        <div class="single-category style-02 wow fadeInDown" data-wow-delay=".2s">
                            <div class="icon">
                                <img src="assets/img/category/c4.png" alt="">
                            </div>
                            <div class="category-contents">
                                <h4 class="category-title"> <a href="javascript:void(0)"> Saloon </a> </h4>
                                <span class="category-para"> 24+ Service </span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-md-4 col-sm-6 margin-top-30 category-child">
                        <div class="single-category style-02 wow fadeInUp" data-wow-delay=".2s">
                            <div class="icon">
                                <img src="assets/img/category/c5.png" alt="">
                            </div>
                            <div class="category-contents">
                                <h4 class="category-title"> <a href="javascript:void(0)"> Painting </a> </h4>
                                <span class="category-para"> 32+ Service </span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-md-4 col-sm-6 margin-top-30 category-child">
                        <div class="single-category style-02 wow fadeInDown" data-wow-delay=".2s">
                            <div class="icon">
                                <img src="assets/img/category/c6.png" alt="">
                            </div>
                            <div class="category-contents">
                                <h4 class="category-title"> <a href="javascript:void(0)"> Helping </a> </h4>
                                <span class="category-para"> 21+ Service </span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-md-4 col-sm-6 margin-top-30 category-child">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        <div class="section-title">
                            <h2 class="title"> Why Our Marketplace? </h2>
                            ...
                            <div class="clientlogo-slider dot-style-one dot-02">
                                <div class="clientlogo-item">
                                    <div class="single-clientlogo">
                                        <div class="thumb">
                                            <a href="javascript:void(0)"> <img src="assets/img/clientlogo/cl1.png"
                                                    alt=""> </a>
                                        </div>
                                    </div>
                                </div>
                                <div class="clientlogo-item">
                                    <div class="single-clientlogo">
                                        <div class="thumb">
                                            <a href="javascript:void(0)"> <img src="assets/img/clientlogo/cl2.png"
                                                    alt=""> </a>
                                        </div>
                                    </div>
                                </div>
                                <div class="clientlogo-item">
                                    <div class="single-clientlogo">
                                        <div class="thumb">
                                            <a href="javascript:void(0)"> <img src="assets/img/clientlogo/cl3.png"
                                                    alt=""> </a>
                                        </div>
                                    </div>
                                </div>
                                <div class="clientlogo-item">
                                    <div class="single-clientlogo">
                                        <div class="thumb">
                                            <a href="javascript:void(0)"> <img src="assets/img/clientlogo/cl4.png"
                                                    alt=""> </a>
                                        </div>
                                    </div>
                                </div>
