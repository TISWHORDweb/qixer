                    ...
                    <div class="dashboard-close-main">
                        ...
                        <div class="dashboard-top padding-top-40">
                            ...
                            <div class="author-content">
                                <h4 class="title"> Alex Jenin </h4>
                                <span class="small-title"> Owner CleanMart </span>
                            </div>
                        </div>
                        <div class="dashboard-bottom margin-top-35 margin-bottom-50">
                            <ul class="dashboard-list ">
                                <li class="list">
                                    <a href="dashboard.html"> <i class="las la-th"></i> Dashboard </a>
                                </li>
                                <li class="list has-children">
                                    <a href="javascript:void(0)"> <i class="las la-cogs"></i> Services </a>
                                    <ul class="submenu">
                                        <li class="list"> <a href="dashboard_services.html"> All Services </a> </li>
                                        <li class="list"> <a href="dashboard_service_edit.html"> Edit Services </a>
                                        </li>
                                        <li class="list"> <a href="dashboard_edit_service_two.html"> Edit Services Two
                                            </a> </li>
                                    </ul>
                                </li>
                                <li class="list">
                                    <a href="dashboard_orders_pending.html"> <i class="las la-tasks"></i> Order Pending
                                    </a>
                                </li>
                                <li class="list">
                                ...
                                <li class="list">
                                    <a href="dashboard_payout.html"> <i class="las la-dollar-sign"></i> Payout History
                                    </a>
                                </li>
                                <li class="list active has-children open show">
                                    ...
                                    <ul class="submenu">
                                        ...
                                        <li class="list"> <a href="dashboard_editprofile.html"> Edit Profile </a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="list">
                                ...
                                <li class="list">
                                    <a href="dashboard_review.html"> <i class="lar la-star"></i> Review </a>
                                </li>
                                <li class="list">
                                    <a href="{{ route('logout') }}"
                                        onclick="event.preventDefault();
                                    document.getElementById('logout-form').submit();">
                                        <i class="las la-sign-out-alt"></i> Log Out </a>
                                </li>
                            ...
                            <div class="dashboard-logo padding-top-20">
                                <a href="index.html" class="logo"> <img src="assets/img/dashboard/dashboard-logo.png"
                                        alt=""> </a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-12">
                            <div class="dashboard-profile">
                                <div class="dashboard-profile-all">
                                    <div class="thumb-ad">
                                        <img src="assets/img/dashboard/ads.jpg" alt="ads">
                                    </div>
                                    <div class="profile-info-dashboard margin-top-40">
                                        <div class="profile-btn-flex">
                                            ...
                                            <div class="btn-wrapper">
                                                <a href="dashboard_editprofile.html" class="cmn-btn btn-bg-1"> Edit
                                                    Profile </a>
                                            </div>
                                        </div>
                                                ...
                                                <div class="dashboard-address-details">
                                                    <ul class="details-list">
                                                        ...
                                                        <li class="lists">
                                                            ...
                                                            <span class="list-strong"> <a
                                                                    href="https://bytesed.com/cdn-cgi/l/email-protection"
                                                                    class="__cf_email__"
                                                                    data-cfemail="c487b1b7b0aba9a1b684a9a5ada8eaa7aba9">[email&#160;protected]</a>
                                                            </span>
                                                        </li>
                                                        <li class="lists">
                                                        ...
                                                        <li class="lists">
                                                            ...
                                                            <span class="list-strong"> 2608 Ritter Avenue Livonia, MI
                                                                48150 </span>
                                                        </li>
                                                    </ul>
